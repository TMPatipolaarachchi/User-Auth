...
const Prehomepage = () => {
 ...
 const [isLoaded, setIsLoaded] = useState(false);
  ...
  const VideoBackground = () => (
    ...
    >
      <iframe
  src="https://www.youtube.com/embed/Z4F3AXvrLKo?autoplay=1&mute=1&controls=0&loop=1&playlist=Z4F3AXvrLKo"
          ...
          >
            ...
            >
              <Link
                ...
                style={{
                  background: 'linear-gradient(135deg,rgb(15, 159, 145) ,rgb(15, 71, 66) ',
